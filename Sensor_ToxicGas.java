...
//		   s.nextLine();
		   ...
		   while(c!=5200){ //have it set to stop sending packets once 100 are sent
			   Thread.sleep(250); //pause for specified time
			
				//generating random values for sensors

//				DecimalFormat two = new DecimalFormat("###.00");  
				int toxicLevel = client.getToxicLevel();
...
//	   Sensor_ToxicGas rpacket = new Sensor_ToxicGas();
	   try{
	...
	int counter = 0;
      while(true){
		  if(counter == 0) {
		   ...
		   Sensor_ToxicGas client1=new Sensor_ToxicGas();
