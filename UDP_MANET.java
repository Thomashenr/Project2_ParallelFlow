...
public class UDP_MANET extends Node {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		while(true){
			...
			try{   
				//check if file has been updated since last checked
                ...
                //recieve packet and pull desired data from it
                ...
                //perform checks to decide to keep packet or not
				if(Integer.parseInt(packetNum) > Integer.parseInt(cache_table[0][1]))
				{
                    ...
                    //loop through nodes and determine whether to send or not, then pass the packet along appropriately
					for(int i=0;i<10;i++)
					{
